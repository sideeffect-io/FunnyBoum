# Agents Overview — Swift Mine Sweeper Game

This repository implements an iOS/iPadOS/macOS mine sweeper game using a functional programming architecture and strong testability guarantees.  
...
- The project is an Xcode project with one production target `FunnyBoom` and one unit tests target `FunnyBoomTests`.
- To maintain the project structure use the XcodeBuildMCP MCP server.
...
- Use the Cupertino MCP server to access the officiel Swift documentation and Apple coding guides.
